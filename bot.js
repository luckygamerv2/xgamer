...
.addField('     **البريفكس [b!] ** ')
.addField('     **(1)-b!help** ' ,' **عشان تجيب الهلب والمساعدة** ')
.addField('     **(2)-b!invite**  ' ,' **عشان تضيف البوت** ')
.addField('     **(3)-b!clear** ' , '**عشان تمسح الشات**') 
.addField('     **(4)-b!bc** ' , '**عشان ترسل بروداسكات**') 
.addField('     **(5)-b!ping** ' ,' ** عشان تعرف سرعة البوت ping** ')
.addField('     **(6)-b!server** ' ,' ** عشان تعرف معلومات السرفر** ')
.addField('     **(7)-b!mc** ' ,' ** عشان تقفل الشات** ')
.addField('     **(8)-b!un_mc** ' ,' ** عشان تفتح الشات** ')
.addField('     **(9)-b!bot** ' ,' ** عشان تعرف احوال البوت  ** ')
.addField('     **(10)-b!send** ' ,' ** عشان ترسل رسالة لشخص علي خاص من البوت  ** ')
.addField('     **(11)-b!paint** ' ,' ** عشان البوت يكرر كلامك علي شكل صورة ** ')
.addField('     **(12)-b!say** ' ,' **  البوت يكرر كلامك علي شكل صورة كتابة ** ')
.addField('     **(13)-b!زواج** ' ,' ** عشان تطلب ايد واحدة بس لازم تمنشن ** ')
.addField('     **(14)-b!chat** ' ,' ** عشان تسوي مكان كتابي لدقيقتان  ** ')
.addField('     **(15)-b!move-all** ' ,' ** عشان تسحب كل الاعضاء في الرومات الي رومك الصوتي وطبعا لازم يكون عندك خاصية التحكم في النقل ** ')
.addField('     **(16)-b!c-c** ' , '** عشان البوت يسوي لك 50 لون عشواءي**') 
.addField('     **(17)** ' , '**عشان اول ما واحد يدخل البوت يطية رتبة لازم يكون اسم الرتبة  MEMBER**') 
.addField('     **(18)-b!avatar** ' , '**عشان تشوف الافتار مالك**') 
.addField('     **(18)-b!id** ' , '**عشان تشوف البروفايل**') 
.addField('     **(19)-b!report** ' , '**عشان تبلغ عن شخص**') 
.addField('     **(20)-b!نكت** ' , '**بيجيب لك نكتة عشواءية تضحك **') 
.addField('     **(21)-b!تقديم** ' , '** عشان تقدم لو تبي تكون ادارة ملحوظة: لازم يكون اكو وم اسمة [التقديمات] عشان التقيدم يكتب فية**') 
.addField('     **(22)-b!طلب** ' , '** غشان تسوي طلب من شخص لو اكو سرفر شراء او هيك ملحوظة: لازم يكون اكو روم اسمة [الطلبات] عشان يكتب الطلب فيها**') 
.addField('     **(23)-b!inv [اسم البوت]** ' , '** لو عايز تعرف رابط اضافة اي بوت **') 
.addField('     **الترحيب** ' , '** [welcome] لو تبي البوت يرحب باللي يدخلوا لازم تخلي اسم الروم مال الترحيب **') 
.addField('     **هيك تكون اوامر البوت اتمني يكون عجبكم :)**')
